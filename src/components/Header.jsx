...
const Header = () => {
  ...
  const items = [
    {
      ...
      links: [
        ...
        { label: "Database", ariaLabel: "", href: "/database" },
      ],
    },
    {
      label: "Look-Outs",
      ...
      textColor: "#fff",
      links: [
        { label: "Roadmap", ariaLabel: "", href: "/roadmap" },
        { label: "Code Journey AI", ariaLabel: "", href: "/code-journey-ai" },
        { label: "Code Journey Editor", ariaLabel: "", href: "/code-journey-editor" },
  ...
  return (
    <div className="card-nav-container fixed left-1/2 -translate-x-1/2 w-[90%] max-w-[900px] z-[99] top-[1.2em] md:top-[2em] rounded-xl overflow-hidden">
      <nav
        ref={navRef}
        className={`card-nav ${isExpanded ? "open" : ""
          } block h-[60px] p-0 shadow-md relative overflow-hidden will-change-[height]`}
        style={{
      ...
      >
        <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-[2]">
          ...
          <div className="logo-container flex items-center md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 order-1 md:order-none gap-3">
            <Link to="/" className="flex items-center gap-3">
              <img src={logo} alt="Logo" className="logo h-[36px]" />
              <span className="text-white font-bold text-xl sm:text-2xl font-sans">
                CODE JOURNEY
              </span>
            </Link>
          </div>
